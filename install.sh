...
echo "   2) On ViciBox (http / https / IP / domain all accepted):"
echo "      bash /root/vicidialaiamd/vicibox_install.sh https://YOUR_DOMAIN oam_YOUR_API_KEY"
echo "      bash /root/vicidialaiamd/vicibox_install.sh http://${IP} oam_YOUR_API_KEY"
echo "      bash /root/vicidialaiamd/vicibox_install.sh ${IP} oam_YOUR_API_KEY"
echo "   Or: curl .../vicidialaiamd/.../remote-install.sh | bash -s -- <base> oam_KEY"
echo ""
